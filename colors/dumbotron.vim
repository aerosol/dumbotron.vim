...
if &background == "light"
    ...
    hi DiffAdd gui=NONE guifg=NONE guibg=#9dff98
    hi DiffChange gui=NONE guifg=NONE guibg=#d0fdff
    hi DiffDelete gui=NONE guifg=NONE guibg=#ffcdcd
    hi DiffText gui=NONE guifg=NONE guibg=#ebf3ff
    ...
    hi Search gui=NONE guifg=NONE guibg=#eff991
    ...
    hi SpellBad gui=NONE guisp=NONE guifg=#ff8ca5 guibg=NONE
    hi SpellCap gui=NONE guisp=NONE guifg=NONE guibg=NONE
    hi SpellLocal gui=NONE guisp=NONE guifg=NONE guibg=#f0fff0
    hi SpellRare gui=NONE guisp=NONE guifg=NONE guibg=#ededed
    ...
    hi Visual gui=NONE guifg=NONE guibg=#d7cfff
